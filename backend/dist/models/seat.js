...
schema.index({ event: 1, heldBy: 1 }, { unique: true, partialFilterExpression: { heldBy: { $type: 'objectId' } } });
schema.index({ event: 1, bookedBy: 1 }, { unique: true, partialFilterExpression: { bookedBy: { $type: 'objectId' } } });
